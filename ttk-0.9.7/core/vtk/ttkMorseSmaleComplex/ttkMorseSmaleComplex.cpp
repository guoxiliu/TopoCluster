...
int ttkMorseSmaleComplex::doIt(vector<vtkDataSet *> &inputs,
  ...
  if(inputOffsets->GetDataType()!=VTK_INT and inputOffsets->GetDataType()!=VTK_ID_TYPE){
    cerr << "[ttkMorseSmaleComplex] Error : input offset field type not supported." << endl;
    return -1;
  }
#endif
  ...
  vtkSmartPointer<ttkSimplexIdTypeArray> 
    ascendingManifold=vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
  if(!ascendingManifold){
    cerr << "[ttkMorseSmaleComplex] Error : ttkSimplexIdTypeArray allocation problem." << 
      endl;
    return -1;
  }
#endif
  ...
  vtkSmartPointer<ttkSimplexIdTypeArray> 
    descendingManifold=vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
  ...
  vtkSmartPointer<ttkSimplexIdTypeArray> 
    morseSmaleManifold=vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
  ...
  switch(inputScalars->GetDataType()){
    ...
    vtkTemplateMacro(({
      ...
      if (ComputeAscendingSeparatrices1 or ComputeDescendingSeparatrices1 or
        ...
        vtkSmartPointer<ttkSimplexIdTypeArray>
          cellIds = vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
        if (!cellIds) {
          cerr << "[ttkMorseSmaleComplex] Error : ttkSimplexIdTypeArray allocation "
            << "problem." << endl;
        ...
        vtkSmartPointer<ttkSimplexIdTypeArray>
          sourceIds = vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
        if (!sourceIds) {
          cerr << "[ttkMorseSmaleComplex] Error : ttkSimplexIdTypeArray allocation "
            << "problem." << endl;
        ...
        vtkSmartPointer<ttkSimplexIdTypeArray>
          destinationIds = vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
        if (!destinationIds) {
          cerr << "[ttkMorseSmaleComplex] Error : ttkSimplexIdTypeArray allocation "
            << "problem." << endl;
        ...
        vtkSmartPointer<ttkSimplexIdTypeArray>
          separatrixIds = vtkSmartPointer<ttkSimplexIdTypeArray>::New();
#ifndef TTK_ENABLE_KAMIKAZE
        if (!separatrixIds) {
          cerr << "[ttkMorseSmaleComplex] Error : ttkSimplexIdTypeArray allocation "
            << "problem." << endl;
      ...
      if (dimensionality == 3 and (ComputeAscendingSeparatrices2 or 
        ...
        if (!sourceIds) {
          cerr 
            << "[ttkMorseSmaleComplex] Error : ttkSimplexIdTypeArray allocation problem."
            << endl;
          return -1;
        }
#endif
  ...
  {
    stringstream msg;
    msg << "[ttkMorseSmaleCompelx] Time usage: " << t.getElapsedTime() << " s." << endl;
    msg << "[ttkMorseSmaleComplex] Memory usage: " << m.getValue_in_MB(false) << " MB." << endl;
