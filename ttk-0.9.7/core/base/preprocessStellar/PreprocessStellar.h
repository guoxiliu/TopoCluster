...
/// \date The Date Here.
///
/// \brief TTK %preprocessStellar processing package.
///
/// %PreprocessStellar is a TTK processing package that takes a scalar field on the input 
/// and produces a scalar field on the output.
///
/// \sa ttk::Triangulation
/// \sa ttkPreprocessStellar.cpp %for a usage example.
...
namespace ttk{
  ...
  class PreprocessStellar : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See ttkPreprocessStellar 
